...
# software
ref=/project/fujun/01.assembly/02.flye/run1/pilon/pilon1x/pilon1x.fasta
...
$bwa mem -t 16 -M -R "@RG\tID:$sample\tLB:$sample\tSM:$sample" $ref $fastq1 $fastq2|$samtools view -b -t ${ref}.fai - > ${sample}.bam
